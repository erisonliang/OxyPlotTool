...
namespace DynamicTypeDescriptor
{
	...
	public class DynamicCustomTypeDescriptor : CustomTypeDescriptor
	{
		...
		private Type m_instance = null;
		private Hashtable m_hashRM = new Hashtable();
		public DynamicCustomTypeDescriptor(ICustomTypeDescriptor ctd, Type instance)
		  : base(ctd)
		{
			m_instance = instance;
			GetProperties();
		...
		public override PropertyDescriptorCollection GetProperties()
		{
			if (m_pdl.Count == 0)
			{
				...
				foreach (PropertyDescriptor pd in pdc)
				{
					...
					{
						CustomPropertyDescriptor cpd = new CustomPropertyDescriptor(null, pd);
						m_pdl.Add(cpd);
					}
				}
			}
	...
	{
		public static DynamicCustomTypeDescriptor Install(Type instance)
		{
